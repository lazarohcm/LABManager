...
class Noticia extends \LabManager\Bean\Noticia implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'id', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'titulo', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'texto', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'capa', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'data', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'noticiaLaboratorio');
        }
     ...
     * {@inheritDoc}
     */
    public function setNoticiaLaboratorio(\LabManager\Bean\NoticiaLaboratorio $noticiaLaboratorio)
    {
