 ...
 */
class Noticia extends \LabManager\Bean\Noticia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'id', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'titulo', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'texto', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'capa', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'data', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'noticiaLaboratorio', '' . "\0" . 'LabManager\\Bean\\Noticia' . "\0" . 'projeto');
        }
     ...
     * {@inheritDoc}
     */
    public function getNoticiaLaboratorio()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNoticiaLaboratorio', array());

        return parent::getNoticiaLaboratorio();
    }

    /**
     * {@inheritDoc}
     */
    public function setNoticiaLaboratorio($noticiaLaboratorio = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNoticiaLaboratorio', array($noticiaLaboratorio));

        return parent::setNoticiaLaboratorio($noticiaLaboratorio);
    }
     ...
     * {@inheritDoc}
     */
    public function setNoticiaProjeto($projeto = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNoticiaProjeto', array($projeto));

        return parent::setNoticiaProjeto($projeto);
    }
